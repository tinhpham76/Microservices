...
export class ClientServices extends BaseService {
    ...
    delete(id) {
        return this.http.delete(`${environment.admin_api_url}/api/clients/${id}`, { headers: this._sharedHeaders })
            .pipe(catchError(this.handleError));
    }
    // Setting basic
    getBasic(id) {
        return this.http.get(`${environment.admin_api_url}/api/clients/${id}/basics`
            , { headers: this._sharedHeaders }).pipe(catchError(this.handleError));
    }
    putBasic(id, entity: any) {
        return this.http.put(`${environment.admin_api_url}/api/clients/${id}/basics`
    ...
    getSetting(id) {
        return this.http.get(`${environment.admin_api_url}/api/clients/${id}/settings`
            , { headers: this._sharedHeaders }).pipe(catchError(this.handleError));
    }
    putSetting(id, entity: any) {
        return this.http.put(`${environment.admin_api_url}/api/clients/${id}/settings`
            , JSON.stringify(entity), { headers: this._sharedHeaders }).pipe(catchError(this.handleError));
    }
    getClientSecret(id: string) {
        return this.http.get(`${environment.admin_api_url}/api/clients/${id}/settings/clientSecrets`, { headers: this._sharedHeaders })
            .pipe(catchError(this.handleError));
    }
    addClientSecret(id: string, entity: any) {
        return this.http.post(`${environment.admin_api_url}/api/clients/${id}/settings/clientSecrets`,
    ...
    // Setting Token
    getToken(id) {
        return this.http.get(`${environment.admin_api_url}/api/clients/${id}/Tokens`
            , { headers: this._sharedHeaders }).pipe(catchError(this.handleError));
    }
    putToken(id, entity: any) {
        return this.http.put(`${environment.admin_api_url}/api/clients/${id}/Tokens`
            , JSON.stringify(entity), { headers: this._sharedHeaders }).pipe(catchError(this.handleError));
    }
    getClientClaims(id: string) {
        return this.http.get(`${environment.admin_api_url}/api/clients/${id}/tokens/clientClaims`, { headers: this._sharedHeaders })
            .pipe(catchError(this.handleError));
    }
    addClientClaim(id: string, entity: any) {
        return this.http.post(`${environment.admin_api_url}/api/clients/${id}/tokens/clientClaims`,
            JSON.stringify(entity), { headers: this._sharedHeaders })
            .pipe(catchError(this.handleError));
    }
    ...
    // Setting device flow
    getDeviceFlow(id) {
        return this.http.get(`${environment.admin_api_url}/api/clients/${id}/deviceFlows`
            , { headers: this._sharedHeaders }).pipe(catchError(this.handleError));
    }
    putDeviceFlow(id, entity: any) {
        return this.http.put(`${environment.admin_api_url}/api/clients/${id}/deviceFlows`
            , JSON.stringify(entity), { headers: this._sharedHeaders }).pipe(catchError(this.handleError));
    }
}